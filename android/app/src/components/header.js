...
function Header (Prop)  {
    const {back,dark,navigation,style,onPress,buttonOnRight,buttonTitle,textOnMiddle,middleText,middleTextStyle} = Prop
   return   (
    ...
    {textOnMiddle && <Text style={{fontSize:24,color:"white",fontWeight:"700",...middleTextStyle}} >{middleText}</Text>}
    </View>
